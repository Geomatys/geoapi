 ...
 * @since 2.0
 *
 * @deprecated Renamed {@link Omission}.
 */
@Deprecated
@UML(identifier="CompletenessOmission", specification=ISO_19157, version=2013)
public interface CompletenessOmission extends Omission {
}