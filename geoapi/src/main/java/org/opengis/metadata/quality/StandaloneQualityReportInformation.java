 ...
 * @since   3.1
 *
 * @deprecated Renamed {@link QualityEvaluationReportInformation}.
 */
@Deprecated
@UML(identifier="StandaloneQualityReportInformation", specification=ISO_19157, version=2013)
public interface StandaloneQualityReportInformation extends QualityEvaluationReportInformation {
}
