...
public final class ValueStructure extends CodeList<ValueStructure> {
    ...
    * that may be repeated(ISO 19107:2003).
    */
    ...
    */
    ...
    /**
    * an arrangement of data in which each item may
    * be identified by means of arguments or keys (ISO/IEC 2382-4:1999).
    */
    ...
    * from its range for any direct position within its spatial,
    * temporal or spatiotemporal domain (ISO 19123:2005).
    */
