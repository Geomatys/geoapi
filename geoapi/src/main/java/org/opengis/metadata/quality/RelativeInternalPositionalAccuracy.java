 ...
 * @since   2.0
 *
 * @deprecated Renamed {@link RelativePositionalAccuracy}.
 */
@Deprecated
@UML(identifier="RelativeInternalPositionalAccuracy", specification=ISO_19157, version=2013)
public interface RelativeInternalPositionalAccuracy extends RelativePositionalAccuracy {
}