 ...
 * @since   2.0
 *
 * @deprecated Renamed {@link AbsolutePositionalAccuracy}.
 */
@Deprecated
@UML(identifier="AbsoluteExternalPositionalAccuracy", specification=ISO_19157, version=2013)
public interface AbsoluteExternalPositionalAccuracy extends AbsolutePositionalAccuracy {
}