...
public interface Parameter {
     ...
     *
     * @return returns the name of the data quality parameter.
     */
     ...
     *
     * @return returns the definition of the data quality paremeter.
     */
     ...
     *
     * @return returs the description of the data quality paremeter.
     */
     ...
     *
     * @return returns the value type of the data quality paremeter.
     */
     ...
     *
     * @return returns the structure of the data quality parameter.
     */
