 ...
 * @since 2.0
 *
 * @deprecated Renamed {@link Commission}.
 */
@Deprecated
@UML(identifier="CompletenessCommission", specification=ISO_19157, version=2013)
public interface CompletenessCommission extends Commission {
}